...
module.exports = (deployer, network) => {
  deployer.then(async () => {
    ...
    console.log('Starting bootstrap automated job 1: weekly period initialization');
    ...
    console.log('Starting bootstrap automated job 2: allowing DAI and USDC on StakeRegistry');
    ...
    console.log('Starting bootstrap automated job 3: Adding the network names to the NetworkAnalytics contract');
    const networkAnalytics = await NetworkAnalytics.deployed();
    await networkAnalytics.addMultipleNetworks(SENetworkNamesBytes32);

    console.log('Starting bootstrap automated job 4: Increasing allowance for NetworkAnalytics and SEMessenger with 25 link tokens');
    ...
    console.log('Starting bootstrap automated job 5: Registering messenger on the SLARegistry');
